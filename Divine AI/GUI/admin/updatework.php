...
$db = $database->getConnection();
  ...
  if (isset($_POST['submit'])) {
    $stmt->updateWork($_POST['naziv'],$_POST['opis']);
    header("Location: singlework.php?id_mesto=$stmt->id_radno_mesto");
     exit();
  }
...
Logout
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="singlework.php?id_mesto=<?php echo $stmt->id_radno_mesto ?>" class="d-none d-sm-inline-block btn  btn-success shadow-sm"> Vrati se na 
              <?php echo $stmt->naziv; ?></a>
          </div>
  ...
  <div class="container">
    ...
    <div class="form-group">
      <input type="text" name="naziv" class="form-control" value="<?php echo $stmt->naziv ?>">
    </div>
   <div class="form-group">
      <input type="text" name="opis" class="form-control" value="<?php echo $stmt->opis ?>">
    </div>
     <div class="form-group">
      <input type="submit" onclick="return confirm('Da li ste sigurni?')" name="submit" id="submit" class="form-control btn btn-danger" value="Potvrdi">
    </div>
  </form>
  </div>
</div>
