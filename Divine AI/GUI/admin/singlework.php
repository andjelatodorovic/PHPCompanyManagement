      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="updatework.php?edit=<?php echo $work->id_radno_mesto ?>" class="d-none d-sm-inline-block btn  btn-info shadow-sm"> Izmeni</a>
            
            <a onclick="return confirm('Da li ste sigurni da zelite da obrisete radno mesto?')" href="deletework.php?delete=<?php echo $work->id_radno_mesto ?>" class="d-none d-sm-inline-block shadow-sm">
              <?php 
            if ($work->ukupno_radnika == 0) {
              echo "<input type = 'submit' class = 'btn btn-danger'  value = 'Izbriši'>";
            } else {
               echo "<input type = 'submit' class = 'btn btn-danger'  value = '
                              Ne mozete izbrisati radno mesto koje ima zaposlene' disabled>";
            }
          ...
          <!-- Content Row -->
          <div class="jumbotron jumbotron-fluid darkpink-bg myjumbo ">
  <div class="container">
